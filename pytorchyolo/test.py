...
from pytorchyolo.utils.datasets import ListDataset, my_dataset_LMDB_PKL, my_dataset_HDF5_PKL, ListDataset_PKL
from pytorchyolo.utils.dataset_hdf5 import HDF5Dataset
...
def _create_validation_data_loader(img_path, batch_size, img_size, n_cpu):
    ...
    :rtype: DataLoader
    """
    dataset = HDF5Dataset(img_path, img_size=img_size, multiscale=False, transform=DEFAULT_TRANSFORMS)
    # dataset = my_dataset_HDF5_PKL(img_path, img_size=img_size, multiscale=False, transform=DEFAULT_TRANSFORMS)
...
def run():
    ...
    # Path to file containing all images for test
